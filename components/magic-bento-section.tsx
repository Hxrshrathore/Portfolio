...
export default function MagicBentoSection() {
  return (
    <section className="relative w-full bg-black pt-24 md:pt-40 pb-16 md:pb-24 overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-20">
          <h2 className="text-3xl md:text-7xl font-bold bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent mb-4 md:mb-6 tracking-tight px-2">But, why me?</h2>
