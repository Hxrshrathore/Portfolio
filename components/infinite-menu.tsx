          ...
          <div className="hidden md:block">
            <h2
              className={`
                ...
                transition-all [transition-timing-function:cubic-bezier(0.25,0.1,0.25,1.0)]
                ${
                  isMoving
              ...
              className={`
                ...
                ${
                  isMoving
                    ...
                    : "bottom-16 md:bottom-[3.8em] opacity-100 pointer-events-auto duration-500 scale-100 -translate-x-1/2"
                }
              `}
            >
